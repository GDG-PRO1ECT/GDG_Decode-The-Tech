...
const round2Questions = [
  ...
  { question: 'Identify the app or platform from this emoji clue', emojiClue: '🕸️ 🕷️ 📜', options: ['API', 'Web Crawler', 'Bug', 'Web Scraper'], correctAnswer: 'Web Crawler', explanation: 'Web crawlers navigate the spider web of the internet.' },
  ...
  { question: 'Identify the app or platform from this emoji clue', emojiClue: '☕ 💻 ⌨️', options: ['Java', 'Python', 'C++', 'Ruby'], correctAnswer: 'Python', explanation: 'Python (as per clue in image).' },
  ...
  { question: 'Identify the app or platform from this emoji clue', emojiClue: '🔘 🎬 ▶️', options: ['Vimeo', 'DailyMotion', 'YouTube', 'Twitch'], correctAnswer: 'YouTube', explanation: 'YouTube video platform.' },
